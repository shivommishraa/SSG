  ...
  <div class="dashboard-ecommerce">
    <div class="container-fluid dashboard-content ">
      <div class="row">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
          <div class="page-header">
            <h2 class="pageheader-title">Manage NewsLatter</h2>
            <div class="page-breadcrumb">
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="<?php echo site_url(); ?>Dashboard" class="breadcrumb-link">Dashboard</a></li>
                  <li class="breadcrumb-item"><a href="">Customer</a></li>
                  <li class="breadcrumb-item"><a href="">Manage NewsLatter</a></li>
                </ol>
              </nav>
            </div>
          </div>
      ...
      <div class="row">
       <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="card">
          <form  role="form" action="<?php echo site_url(); ?>Customer/NewsLatter/manageNewslatter" method="post">
           <div class="row col-md-12">
             ...
             <div class="col-md-4 card-header">
              ...
              <div class="col-md-3 card-header">
                ...
                <button class="btn btn-sm btn-danger"  onClick="return redirect('<?php echo base_url();?>Customer/NewsLatter/manageNewslatter');">Reset</button>
              </div>
              <!-- <div class="col-md-2 card-header text-right">
                <button class="btn btn-sm btn-primary"  onClick="return redirect('<?php //echo site_url(); ?>Customer/NewsLatter/addNewFrontendCustomer');"><i class="fa fa-plus" aria-hidden="true"></i> Add New</button>
              </div> -->
            </div>
          </form>
          ...
          <div class="table-responsive">
           <?php if(!empty($newsLatter)) {?>
            <table class="table table-striped table-bordered first">
              ...
              <tbody>
              <?php $i=1; foreach($newsLatter as $newsLatter) { ?>
              <tr>
                <td><?php echo $i; ?> </td>
                <td><?php echo $newsLatter->newslatteremail; ?> </td>
