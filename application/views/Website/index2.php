...
.btn-block span {
    ...
    color: #D0E6FF
                            ...
                            <body style="background-color:white;" oncontextmenu='return false' class='snippet-body'>
...
<p class="mb-1" style="font-size: 19px;text-align: center;">!!..Coming Soon..!!</p>
 ...
 <p style="color: white; font-size: 10px; margin-top: 1px";>Designed By:- S.S.G Group</p>
    ...
    <form method="POST" action="<?php echo base_url() ?>Website/Website_controller/hostinsert">
        ...
        <span style="text-align:justify; font-weight:bold;">आदिशक्ति मां दुर्गा की आठवीं वर्षगांठ पर मैं मां को नमन करता हूं। मां सभी को सुख और समृद्धि का आशीर्वाद देंं।</span><br/>
...
<p id="" style="color:yellow; font-size:20px; text-align: center; padding-top: 5px;">Countdown Timer</p>
...
<div class="text">
<p class="val"id="type-days" style="color:navy;">0</p>
...
<div class="text">
<p class="val"id="type-hours" style="color:red;">0</p>
...
<div class="text">
<p class="val"id="type-minutes" style="color:yellow;">0</p>
...
<div class="text">
<p class="val" id="type-seconds" style="color:green;">0</p>
...
var countDownDate = new Date("July 06, 2023 16:00").getTime();
