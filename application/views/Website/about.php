...
<?php include('ms_header.php'); ?>
    ...
    <div class="tm-hero d-flex justify-content-center align-items-center" data-parallax="scroll" data-image-src="<?php echo base_url(); ?>Web_assests/img/hero.jpg"></div>
        ...
        <div class="row tm-mb-74 tm-row-1640">            
            ...
            <div class="col-lg-7 col-md-6 col-12">
                <div class="tm-about-img-text">
                    <p class="mb-4">
                  You may support website by making <a href="www.mobilestatus.in" target="_parent" rel="sponsored">a small contribution</a>. This will be helpful for us. We hope you like this for your website. <a rel="sponsored" href="https://www.mobilestatus.com" target="_parent"></a></p>
                    <p>
                        Credits go to Pexels and Unsplash for photos and video used in this template.<a rel="sponsored" href="https://www.mobilestatus.in/">Bootstrap 5</a>Template designed for video and photo websites.</p> 
                    <p>You are <b>allowed</b> to use this template for your commercial or non-commercial websites. You can integrate it with any kind of CMS website. You are <b>NOT allowed</b> to redistribute the downloadable template ZIP file on any template collection website. Please <a rel="nofollow" href="https://www.mobilestatus.in" target="_parent">contact us</a> for more information. Thank you.</p>
                </div>                
            </div>
        </div>
