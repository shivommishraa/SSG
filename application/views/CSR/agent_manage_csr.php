  ...
  <div class="dashboard-ecommerce">
    <div class="container-fluid dashboard-content ">
      <div class="row">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
          <div class="page-header">
            <h2 class="pageheader-title">Manage Agent CSR</h2>
            <div class="page-breadcrumb">
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="<?php echo site_url(); ?>Dashboard" class="breadcrumb-link">Dashboard</a></li>
                  <li class="breadcrumb-item"><a href="">CSR</a></li>
                  <li class="breadcrumb-item "><a href="">Manage Agent CSR</a>
                  </li>
      ...
      <div class="row">
       <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="card">
          <form  role="form" action="<?php echo site_url(); ?>CSR/CSR_Controller/manage_csr" method="post">
           ...
           <div class="col-md-4 ">
            ...
            <button class="btn btn-sm btn-danger"   onClick="return redirect('<?php echo base_url();?>CSR/CSR_Controller/manage_csr');"><i class="fas fa-redo"></i> Reset</button>
            <!--  <button  class="btn btn-sm btn-primary from "  onClick="return redirect('<?php echo base_url();?>CSR/CSR_Controller/add_csr');"><i class="fa fa-plus" aria-hidden="true"> </i> Add CSR</button> -->
          </div>
