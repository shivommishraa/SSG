      ...
      <div class="row">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
          <div class="card">
             ...
             <div class="row col-md-12 ">
               ...
               <div class="col-md-6 pt-3 text-right">
                 <button class="btn btn-sm btn-primary"  onClick="return redirect('<?php echo base_url(); ?>Project/ProjectController/frmaddClient');"><i class="fa fa-plus" aria-hidden="true"></i> Add Client</button>
                  <button class="btn btn-sm btn-success"  onClick="return redirect('<?php echo base_url(); ?>Project/ProjectController/projectlist');"><i class="fa fa-list" aria-hidden="true"></i> List Project</button>
                    <button class="btn btn-sm btn-secondary"  onClick="return redirect('<?php echo base_url(); ?>Project/ProjectController/viewprojectdata/<?php echo $Project[0]->pr_id; ?>');"><i class="fas fa-step-backward" aria-hidden="true"></i> Back</button>
               </div>
             </div>
           </h5>
           <form role="form" method="post"class="needs-validation" novalidate="" action="<?php echo base_url()?>Invoice/InvoiceController/addInvoices" enctype="multipart/form-data"></html>
            <div class="card-body text-white" style="background-color: #e2f5f7;"> 
             ...
             <!-- Start Code For tax company state -->
             <input type="hidden" name="com_state" id="com_state" value="<?php echo $setting[10]->Code?>"> 
              <!-- End Code For tax company state -->
              ...
              <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6  pt-2">
                ...
                <input type="number" required="" value="<?php echo set_value('inc_number'); ?>"  class="form-control" id="" name="inc_number" placeholder="Enter Invoice Number . ">
          ...
          <tr id="rec-2">
            ...
            <td><input type="number" value="0"  class="form-control itm_discount" name="itm_discount[]">
            ...
            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-3  pt-2 text-right">
              ...
              <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-3  pt-2 text-left">
                <!-- <span style="color: gray;" value="0" id="total_tax" name="total_tax">₹ 0</span>
                 -->
                 <input type="text" class="form-control"  readonly="" style="color: gray;" value="0" id="total_tax" name="total_tax">
              </div>
              ...
              <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-3  pt-2 text-right">
                ...
                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-3  pt-2 text-left">
                  <input type="text" class="form-control"  readonly="" style="color: gray;" value="0" id="total_discount" name="total_discount">
                </div>
                ...
                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-3  pt-2 text-right">
                  ...
                  <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-3  pt-2 text-left">
                    <input type="text" required="" value="0"  class="form-control shipping_charge" id="shipping_charge" name="shipping_charge" placeholder="Enter Shipping Charge . ">
                  </div>
                  ...
                  <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-3  pt-2 text-right">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-3  pt-2 text-left">
                      <input type="text" required="" value="0" class="form-control extra_discount" id="extra_discount" name="extra_discount" placeholder="Enter Extra Discount. ">
                    </div>
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6  pt-2">
                   ...
                   <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-3  pt-2 text-right">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-3  pt-2 text-left">
                      <input type="text" required="" readonly="" value="0"  class="form-control" id="grand_total" name="grand_total">
                    </div>
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6 pt-2">
                      ...
                      <select required="" value="<?php echo set_value('payment_terms'); ?>"  class="form-control " id="" name="payment_terms">
                        ...
                        <option value="<?php echo $key->term_con_id; ?>"><?php echo $key->term_con_name; ?></option>
                          <?php   } ?>
                      </select>
                    </div>
