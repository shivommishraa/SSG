<div class="modal-dialog modal-md">
  <div class="modal-content">
   <form class="needs-validation"action="<?php echo base_url() ?>/Task/Task_Controller/Update_task_statusforview" method="post" enctype="multipart/form-data" id="contact_form">
