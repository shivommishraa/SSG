         ...
         <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb-5">
          ...
          <div class="tab-regular tab-sm">
            <ul class="nav nav-tabs nav-fill" id="myTab7" role="tablist">
              ...
              <li class="nav-item">
                <a class="nav-link" id="invoice-tab-justify" data-toggle="tab" href="#invoice-justify" role="tab" aria-controls="contact" aria-selected="false">Invoice</a>
              </li>
          ...
          <!-- ================== Start code for Project Invoice ==================== -->

          <div class="tab-pane fade " id="invoice-justify" role="tabpanel" aria-labelledby="invoice-tab-justify">
           <div class="card-body ">
            <a href="#" class="btn btn-block text-center "style="color: #fff; background-color: #ef823b;"><i class="fas fa-info-circle"></i> Invoice</a>
          </div>
          <div class="col-lg-12">
            <div class="col-lg-6 text-left">
              <a href="<?php echo site_url()?>Project/ProjectController/frmProjectInvoice/<?php echo $Project[0]->pr_id; ?>" class="badge badge-primary"> Create New Invoice</a>
            </div>
          </div>
          <div class="container-fluid">
            <div class="table-responsive">
              <?php if(!empty($all_invoice)) {?>
               <div class="card-body ">
               ...
               <tbody>
                <?php $i=1; foreach($all_invoice as $ro) { 

                  if($ro->inc_status>0){
                      $inc_status=$getinc_status($ro->inc_status);
                        $invoice_status=$inc_status[0]->in_sts_name;
                       }else{
                 ...
                 <tr>
                  <td> <?php echo $i; ?> </td>
                  <td> <?php echo '#'.$ro->inc_id ?></td>
                  <td><!-- <span <?php if($ro->inc_status==0){?> class="badge badge-success"<?php }else{ ?> class="badge badge-danger"<?php }?>>
                    <a style="color:#fff;" href="" > <?php if($ro->inc_status==0){ echo "Activate"; } else { echo "Deactivate"; } ?></a></span> -->
                      
                      <span class="badge" style="background-color: #f979a0; color: #fff;">
                         <?php echo $invoice_status ?>
                      </span>
                    </td>
                    
                    <td> <?php echo $ro->inc_due_date ?></td>
                    <td> <?php echo '₹ '.$ro->grand_total.'.00' ?></td><!-- Invoice/InvoiceController/viewInvoice/9 -->
                   <td><a href="<?php echo site_url()?>Invoice/InvoiceController/viewInvoice/<?php echo $ro->inc_id; ?>"><i class="fa fa-id-card"style="color: blue;"></i></a></td>
                  </tr>
                  <?php $i++; } ?>
                </tbody>
              </table>
            <?php }else {?>
              <div class="alert alert-danger" role="alert">
               <strong>Sorry!!..No any Invoices in this Project.</strong>
             </div>
           <?php } ?>
