            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 text-center">
                    <div class="contact__widget">
                        ...
                        <h4>Address</h4>
                        <p>Behind ACE City Building, Village: Aimnabad, Section-1 Greater Noida West 201306</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-6 text-center">
                    <div class="contact__widget">
        ...
        <div class="map-inside">
            ...
            <div class="inside-widget">
                ...
                <ul>
                    ...
                    <li>Add: Behind ACE City Building, Village: Aimnabad, Section-1 Greater Noida West 201306</li>
                </ul>
            </div>
        </div>
    </div>
