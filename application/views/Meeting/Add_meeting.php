      ...
      <div class="row">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
          <div class="page-header">
            <h2 class="pageheader-title">Add Meeting</h2>
      ...
      <div class="row">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
           ...
           <h5 class="card-header">
             <div class="row col-md-12 ">
               ...
               <div class="col-md-4 pt-3 text-right">
                 <button class="btn btn-sm btn-primary"  onClick="return redirect('<?php echo site_url(); ?>Meeting/Meeting_Controller/manage_meeting');"><i class="fa fa-list" aria-hidden="true"></i> List Meeting</button>
               </div>
             </div>
           </h5>
           <div class="card-body">
            <form class="needs-validation" novalidate  method="post" action="<?php echo site_url()?>Meeting/Meeting_Controller/addTbl_meeting">

              <div class="row">
               <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                
                 <label for="validationCustom01">Meeting Title:</label>
                 <input type="text" class="form-control" required id="validationCustom01" placeholder="Meeting Title" name="meeting_title" required="">
          ...
          <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6 mt-2">
           ...
           <input type="date" class="form-control" required id="validationCustom01" name="meeting_date" required="">
           <div class="valid-feedback">
            Looks good!
        ...
        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6 mt-2">
         ...
         <input type="time" class="form-control" required id="validationCustom01" name="meeting_time" required="">
         <div class="valid-feedback">
          Looks good!
