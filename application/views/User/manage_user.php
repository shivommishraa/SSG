  ...
  <div class="dashboard-ecommerce">
    <div class="container-fluid dashboard-content ">
      ...
      <div class="row">
       <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="card">
          <form  role="form" action="<?php echo site_url(); ?>Admin/User_Controller/manage_user" method="post">
           <div class="row col-md-12">
             <div class="col-md-3 card-header">
              ...
              <div class="col-md-3 card-header">
                ...
                <button class="btn btn-sm btn-danger"  onClick="return redirect('<?php echo base_url();?>Admin/User_Controller/manage_user');">Reset</button>
              </div>
        ...
        <div class="table-responsive">
          <?php if(!empty($user)) {?>
            <table class="table table-striped table-bordered first">
             ...
             <tbody>
              <?php $i=1; foreach($user as $ro) { ?>
               <tr>
                <td> <?php echo $i; ?> </td>
                <td> <?php echo $ro->name ?></td>
                <td><?php echo $ro->email_id?></td>
                ...
                <td><span <?php if($ro->status==0){?> class="badge badge-success"<?php }else{ ?> class="badge badge-danger"<?php }?>>
                  ...
                  <td><a href="<?php echo site_url()?>Admin/User_Controller/deleteTbl_user/<?php echo $ro->admin_id?>" onclick="return confirm('are you sure to delete')"><i class="fa fa-trash"style="color: red;"></i></a></td>

                  <td><a href="" onclick="javascript:addteam(<?php echo $ro->admin_id.','.$ro->role_id ?>)" data-toggle="modal" data-target="#modal-info"><i class="fas fa-users" style="color: #0400ff;"></i></a></td> 

                  <td><a href="" onclick="javascript:admincompaign(<?php echo $ro->admin_id ?>)" data-toggle="modal" data-target="#modal-info">Process</a></td>
          ...
          <?php } else {?>
            <div class="alert alert-info" role="alert">
             <strong>No User Record Found!</strong>
           </div>
         <?php } ?>
