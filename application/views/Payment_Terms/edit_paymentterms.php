      ...
      <div class="row">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
          <div class="page-header">
            <h2 class="pageheader-title">Edit Payment Terms</h2>
            ...
            <div class="page-breadcrumb">
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item "><a href="">Edit Payment Terms</a></li>
      ...
      <div class="row">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
          <div class="card">
           ...
           <div class="card-body">
            <form class="needs-validation" novalidate  method="post" action="<?php echo site_url()?>Payment_Terms/Payment_Controller/editTbl_paycon">
              ...
              <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                 ...
                 <input type="text" class="form-control" required id="validationCustom01" placeholder="" name="term_con_name" value="<?php echo $paymentterms[0]->term_con_name; ?>" required=""> 
                 <input type="hidden" class="form-control" required id="validationCustom01" placeholder="" name="term_con_id" value="<?php echo $paymentterms[0]->term_con_id; ?>" required="">
              ...
              <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 pt-3 ">
                ...
                <textarea class="form-control" required="" id="summernote"  name="term_condition" rows="6" placeholder="Write Descriptions"><?php echo $paymentterms[0]->term_condition; ?></textarea>
