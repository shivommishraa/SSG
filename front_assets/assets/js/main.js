...
(function ($) {
    ...
    jQuery(document).ready(function ($) {
        ...
        $("#slideslow-bg").vegas({
            ...
            slides: [
                {
                    src: '../front_assets/assets/img/slider-img/nice_banner_1.jpg'
                },
                {
                    //src: 'assets/img/slider-img/s0.jpg'
                },
                {
                   // src: 'assets/img/slider-img/s1.jpg'
                },
                {
                    //src: 'assets/img/slider-img/s4.jpg'
                }
            ]
        }); //Home Page Two Slideshow
